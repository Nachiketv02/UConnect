      ...
      <div className="singleContainer">
        ...
        <div className="top">
          <div className="left">
            <Link
              to={
                "/users/edit/" + window.localStorage.getItem("userSpecificId")
              }
            ...
            <div className="item">
              ...
              <div className="details">
                ...
                <div className="detailItem">
                  <span className="itemKey">Employee Name:</span>
                  {window.localStorage.getItem("userSpecificId") ? (
                    <span className="itemValue">
                      {SpecificUserDetail.EmployeeName}
                    </span>
                  ) : (
